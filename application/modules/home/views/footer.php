<footer id="footer">
      <div class="top-footer">
        <div class="row">
          <div class="col-9 top-foote-l">
            <img src="<?php echo base_url();?>public/images/logo-top.png" alt="" />
            <div class="top-foote-l-conten">
              <ul>
                <li><a href="<?php echo base_url(); ?>page/gioi-thieu-ve-catdainox/111.html">Giới thiệu về CATDAINOX</a></li>
                ...
                <li><a href="<?php echo base_url(); ?>page/thong-bao-tu-catdainox/106.html">Thông báo từ CATDAINOX</a></li>
                <li><a href="<?php echo base_url(); ?>page/lien-he-voi-catdainox/105.html">Liên hệ với CATDAINOX</a></li>
              </ul>
            </div>
          </div>
          <div class="col-7 top-foote-m">
      ...
      <div class="bot-footer">
        <div class="row">
          <div class="col-16 footer-left">
            <p>CÔNG TY CỔ PHẦN DỊCH VỤ THƯƠNG MẠI THIÊN AN </p>
            <p>Trụ sở chính: SN 688 - Đường Long Hưng - Tổ 3 - Phường Hoàng Diệu</p>
            <p>Cửa hàng: Số 10 - Chợ Bo - Lê Quý Đôn & Số 237 - Lê Quý Đôn</p>
